        ...
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [
                    ...
                    InlineKeyboardButton(
                        "‹ لتنصيب بوت ›", url=f"https://t.me/SourseMUSIC"
                    ),
                ],
                [
                    InlineKeyboardButton(
...
@Client.on_message(command(["مبرمج السورس", f"ذوز", f"ذوز", f"السورس"]) & filters.group & ~filters.edited)
async def start(client: Client, message: Message):
    await message.reply_photo(
        photo=f"https://telegra.ph/file/d457fb0a8d3a987b04fff.jpg",
        caption=f"""Programmer [SourseMUSIC](https://t.me/SourseMUSIC) 𖡼\nᴛᴏ ᴄᴏᴍᴍụɴɪᴄᴀᴛᴇ ᴛᴏɢᴇᴛʜᴇʀ 𖡼\nғᴏʟʟᴏᴡ ᴛʜᴇ ʙụᴛᴛᴏɴѕ ʟᴏᴡᴇʀ 𖡼""",
        reply_markup=InlineKeyboardMarkup(
         [
            [
                InlineKeyboardButton("℡ ᯓ  ذوز", url=f"https://t.me/SourseMUSIC"),
            ],
            [
                InlineKeyboardButton(
                    "-ذوز .", url=f"https://t.me/B_o_d_a_90"
                ),
            ],
            [
...
async def help(client: Client, message: Message):
    await message.reply_photo(
        ...
        reply_markup=InlineKeyboardMarkup(
         [
            [
                InlineKeyboardButton("𓌹℡ ᯓ  ذوز", url=f"https://t.me/SourseMUSIC"),
            ],
            [
                InlineKeyboardButton(
